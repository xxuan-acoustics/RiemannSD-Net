...
from wenet.transformer.encoder_layer import new_ConformerEncoderLayer
from wenet.transformer.encoder_layer import Squeeze_ConformerEncoderLayer
...
from wenet.transformer.subsampling import Conv2dSubsampling1
from wenet.transformer.subsampling import DW_Conv2dSubsampling2,CNTF#ADD
...
class BaseEncoder(torch.nn.Module):
    def __init__(
        ...
        elif input_layer == "DW_conv2d2":
            print("DW_conv2d2")
            subsampling_class = DW_Conv2dSubsampling2
        elif input_layer == "conv2d1":
            print("conv2d1")
            subsampling_class = Conv2dSubsampling1
        elif input_layer == "CNTF":
            subsampling_class = CNTF
        else:
...
class new_ConformerEncoder(BaseEncoder):
...
class Squeeze_ConformerEncoder(BaseEncoder):
    """Squeeze_Conformer encoder module."""
    def __init__(
        self,
        input_size: int,
        output_size: int = 256,
...
class CNTF_ConformerEncoder(BaseEncoder):
    """Squeeze_Conformer encoder module."""
    def __init__(
        self,
        input_size: int,
