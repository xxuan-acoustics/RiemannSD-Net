...
class new_ConformerEncoderLayer(nn.Module):
    """Encoder layer module.
    Args:
        size (int): Input dimension.
        self_attn (torch.nn.Module): Self-attention module instance.
    ...
    def forward(
        ...
        return x, mask, new_cnn_cache
class Squeeze_ConformerEncoderLayer(nn.Module):
    """Encoder layer module.
    Args:
        size (int): Input dimension.
        self_attn (torch.nn.Module): Self-attention module instance.
    ...
    def forward(
        ...
        # whether to use feed_forward
        residual = x
        x = residual + self.dropout(self.feed_forward_macaron(x))
        x = self.norm_ff_macaron(x)
